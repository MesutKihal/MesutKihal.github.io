...
const mat = [{"title": "الرياضيات", "id": "mth", "logo": "static/img/prm-math.png"},
			 {"title": "اللغة العربية", "id": "arb","logo": "static/img/prm-arabic.png"},
			 {"title": "التربية الإسلامية", "id": "ism", "logo": "static/img/prm-islam.png"},
			 {"title": "التربية الفنية", "id": "art", "logo": "static/img/prm-art.png"},
			 {"title": "الموسيقى", "id": "msc", "logo": "static/img/prm-music.png"},
			 {"title": "اللغة الفرنسية", "id": "frn", "logo": "static/img/prm-francais.png"},
			 {"title": "اللغة الانجليزية", "id": "eng", "logo": "static/img/prm-english.png"},
			 {"title": "التربية العلمية", "id": "sci", "logo": "static/img/prm-physics.png"},
			 {"title": "التربية المدنية", "id": "civ", "logo": "static/img/prm-civil.png"},
			 {"title": "التاريخ و الجغرافيا", "id": "hig", "logo": "static/img/prm-hisgeo.png"},
			 {"title": "الاجتماعيات", "id": "soc", "logo": "static/img/prm-hisgeo.png"},
			 {"title": "علوم الطبيعة والحياة", "id": "bio", "logo": "static/img/bio.png"},
			 {"title": "العلوم الفيزيائية", "id": "phy", "logo": "static/img/prm-physics.png"},
			 {"title": "الاعلام الألي", "id": "cms", "logo": "static/img/cs.png"},
		     {"title": "التكنولوجيا", "id": "tec", "logo": "static/img/techno.png"},
			 {"title": "القانون", "id": "law", "logo": "static/img/law.png"},
			 {"title": "التسيير المحاسبي", "id": "sta", "logo": "static/img/stats.png"},
			 {"title": "الاقتصاد", "id": "eco", "logo": "static/img/eco.png"},
			 {"title": "اللغة الايطالية", "id": "ita", "logo": "static/img/ita.png"},
			 {"title": "اللغة الألمانية", "id": "ger", "logo": "static/img/ger.png"},
			 {"title": "اللغة الاسبانية", "id": "esp", "logo": "static/img/esp.png"},
			 {"title": "الهندسة الميكانيكية", "id": "mce", "logo": "static/img/mce.png"},
			 {"title": "الهندسة الكهربائية", "id": "ele", "logo": "static/img/ele.png"},
			 {"title": "الهندسة المدنية", "id": "cve", "logo": "static/img/cve.png"},
			 {"title": "الفلسفة", "id": "phi", "logo": "static/img/phi.png"}]
...
fetch('news/', {
	...
	newsDiv.setAttribute("class", "box bar rows centered h-5");
	...
	for (var i = 0; i < limit; i++)
	{
		...
		title.href = data[i][1];
		title.setAttribute("class", "row nav-3 pd-3 mb-3 col-10 size-ss");
...
function getContent(id)
{
	...
	fetch(`content/${level}/${year}/${field}`, {
		...
		for (var i = 0; i < data[0].length; i++)
		{
			...
			card.setAttribute("class", "rows centered col-3");
			img.setAttribute("class", "row w-8");
			title.setAttribute("class", "row size-sm centered");
			let temp = data[0][i];
			title.onclick = (event) => {
				window.location.href = temp.file;
			}
			img.src = data[0][i].cover;
